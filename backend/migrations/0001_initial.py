    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.appointment')),
            ],
        ),
        migrations.AddField(
            model_name='appointment',
            name='DoctorId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.doctor'),
        ),
        migrations.CreateModel(
            name='LabTest',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('LabTestCategoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.labtestcategory')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.appointment')),
                ('LabTestId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.labtest')),
            ],
        ),
        migrations.CreateModel(
            name='Medicine',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('MedicineCategoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.medicinecategory')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('AppointmentId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.appointment')),
                ('MedicineId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.medicine')),
            ],
        ),
        migrations.CreateModel(
            name='MedicineStock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('MembershipId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.membership')),
            ],
        ),
        migrations.AddField(
            model_name='appointment',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.specialization'),
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('RoleId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.role')),
            ],
        ),
        migrations.AddField(
            model_name='doctor',
            name='StaffId',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='backend.staff'),
        ),
    ]
